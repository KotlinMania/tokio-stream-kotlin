...
This file is the quick-reference operating contract for tokio-stream-kotlin. The longer
...
tokio-stream-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tokio-stream`](https://crates.io/crates/tokio-stream). Upstream Rust is the behavioral oracle while the
